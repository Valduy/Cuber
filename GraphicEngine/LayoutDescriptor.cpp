...
const graph::LayoutDescriptor graph::LayoutDescriptor::kPosition2Texture2{
	D3D11_INPUT_ELEMENT_DESC {
		"POSITION",
		0,
		DXGI_FORMAT_R32G32_FLOAT,
...
const graph::LayoutDescriptor graph::LayoutDescriptor::kPosition3Normal3Binormal3Tangent3Texture2{
	D3D11_INPUT_ELEMENT_DESC {
		"POSITION",
		0,
		DXGI_FORMAT_R32G32B32_FLOAT,
